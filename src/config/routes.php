...
return [
    ...
    '/api/alcancia/meta/crear-personal' => ['controller' => 'AlcanciaApiController', 'action' => 'crearMetaPersonal'],
    ...
    '/api/alcancia/session/iniciar' => ['controller' => 'AlcanciaApiController', 'action' => 'iniciarSesionPersonal'],
